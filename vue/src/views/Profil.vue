                ...
                <div class="max-w-7 pt-6 px-10 lg:px-8 animate-fade-in-left">
                    <div class="grid lg:flex lg:space-x-4">
                        ...
                        >
                            <div>
                                <div
                                    class="grid px-4 justify-items-center lg:flex items-center lg:space-x-4"
                                >
                                    <div class="grid">
                                        <img
                                    ...
                                    <div class="grid">
                                        <span
                                            class="text-blue-900 font-medium text-sm lg:text-xl"
                                            >{{ model.nama_guru }}
                                        ...
                                        <span class="text-blue-400 text-sm lg:text-base">{{
