                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <tr
                                        v-for="(person, itemIdx) in siswaData.data"
                                        :key="person.nis_siswa"
                                        ...
                                        >
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    >
                                                        {{ person.nama_siswa }} <span class=" text-blue-900">({{ person.nis_siswa }})</span>
                                                    </div>
                                            ...
                                            <div class="grid mt-2 lg:hidden">
                                                <div class="grid">
                                                    ...
                                                    <span class="text-blue-900">
                                                        {{
                                                            person.tempat_lahir_siswa
                                                        }},
                                                        {{
                                                            new Date(
                                                                person.tanggal_lahir_siswa
                                                            ).toLocaleDateString(
                                                                "id-ID",
                                                                {
                                                                    day: "numeric",
                                                ...
                                                >
                                                    ...
                                                    <button type="button" @click.prevent="deleteModal(person.nis_siswa)">
                                                        <DeleteCircleIcon
                                                            :size=35
                        ...
                        <div class="flex justify-center mt-5">
                                ...
                                <a
                                    v-for="(link, i) of siswaData.links"
                                    :key="i"
                                    :disabled="!link.url"
                                    href="#"
                                    ...
                                    :class="[
                                        ...
                                        i === siswaData.links.length - 1 ? 'rounded-r-md' : '',
                                    ]"
                                    v-html="link.label"
                                >
                                </a>
