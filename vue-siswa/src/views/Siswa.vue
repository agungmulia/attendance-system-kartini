            ...
            <div>
                ...
                <div class="max-w-7 pt-6 px-10 lg:px-8 lg:flex lg:space-x-4">
                    <div class="grid lg:w-[50%]">
                        <div
                            class="py-4 grid rounded-t-lg shadow-sm bg-white px-4"
                        >
                            <div class="grid justify-items-center">
                                <img
                                    class="w-40 h-40 rounded-full"
                                    v-if="model.foto_siswa_urk"
                    ...
                    <div class="lg:w-80 py-6 lg:py-0">
                        <div
                            class="bg-white rounded-lg shadow-sm px-4 py-4 text-blue-900 font-medium text-md lg:text-lg"
                        >
